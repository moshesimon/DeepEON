...
class GameView(arcade.View):
    ...
    def on_draw(self):
        ...
        self.text_box(
            ...
            arcade.color.PINK,
            str(
                f"Request: (Source:{self.source}, Target:{self.target}, Slots:{self.slots})"
            ),
        )  # print source node
        ...
        self.text_box(
            1, 12, 6, arcade.color.PINK, "High Score: {}".format(self.high_score)
        )
    ...
    def on_mouse_press(self, x, y, button, key_modifiers):
        ...
        if self.column in [17, 18, 19, 20] and self.row == 13:  # new round clicked
            ...
            self.row == 2
            and self.column < (COLUMN_COUNT * 5 + 4) - self.slots + 2
            and self.column > 0
    ...
    def on_key_press(self, key, modifiers):
        ...
        if (
            ...
            and self.first_slot < (COLUMN_COUNT * 5 + 4) - self.slots
        ):
            self.first_slot += 1
            self.update_spec_grid()

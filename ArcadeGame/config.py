...
full_name = f"{all_configs['number_of_slots']}_{all_configs['K']}_{all_configs['solution_reward']}_{all_configs['rejection_reward']}_{all_configs['seed']}_{all_configs['end_limit']}_{all_configs['env']}"
